                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DataTable(
                        ...
                        dataTextStyle:
                            TextStyle(fontSize: 18.0.h, color: Colors.black),
                        columns: [
                          DataColumn(
                            label: Text(
                              'Order ID',
                                  ...
                                  child: Column(
                                   ...
                                   children: [
                                     Container(
                                       ...
                                       decoration: BoxDecoration(
                                         borderRadius: BorderRadius.circular(5),
                                         image: DecorationImage(image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTEnb4bQKUe6UZLmUIKn1u5BqsTmyTA0S8TA&usqp=CAU',),fit: BoxFit.cover)
                                       ),
                                     ),
                        ...
                        children: [
                          Row(
                            children: [
                              Row(
                                children: [
                                  Image.asset('assets/icons/star_icon.png',height: 20.h,width: 20.w,),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: GridView.count(
                              ...
                              crossAxisSpacing: 5.w, // Space between columns
                              mainAxisSpacing: 5.h, // Space between rows
                              crossAxisCount: 7,
                              childAspectRatio: 2,
                              children: List.generate(49, (index) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: index%3!=0?Color(0xffD3FFE3):Color(0xff036666),
                                  ),
                                );
                              }),
                            ),
