      ...
      child: Scaffold(
        ...
        body: Row(
          ...
          padding:  EdgeInsets.symmetric(
            vertical: 100.h,horizontal: 15.w
          ),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient:LinearGradient(
                      ...
                      colors: [Color(0xFFBB9121), Color(0xFFDFC45D),Color(0xFFF4E57E)],
                    ) ,
                    color: select == index
                        ? Color(0xffBB9121)
                        : Colors.transparent,
                  ),
                  child: IconTitleVertical(color: select!=index?Color(0xFFFFF9C9):ColorManager.kPrimary, image: iconsAndTitlesData[index]['image'].toString(), title: iconsAndTitlesData[index]['title'].toString(),),
                ),
              );
            },
          ),
                  ...
                  Expanded(
                    child: PageView(
                      ...
                      children: [
                        ...
                        OrdersScreen(),
                        ReservationScreen(),
                        BillsScreen(pageController: controller,),
                        MembersScreen(pageController: controller),
                        ReportsScreen(),
                        //Additional interfaces
                        BillDetailsScreen(),
                        AddNewMemberScreen(),
                        NewRecerviationScreen(controller: controller,)
